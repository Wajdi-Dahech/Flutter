...
class ChatScreenState extends State<ChatScreen> {
  ...
  Future uploadFile() async {
    String fileName =
        "chats/${DateTime.now().millisecondsSinceEpoch.toString()}";
    StorageUploadTask uploadTask =
        fireBaseService.getStorage().ref().child(fileName).putFile(imageFile);
        ...
        children: <Widget>[
          document['type'] == 0
              ...
              : document['type'] == 1
                  ...
                  : Container(
                      child: Image.asset(
                        'lib/assets/images/${document['content']}.gif',
                        width: 100.0,
                        height: 100.0,
                        fit: BoxFit.cover,
                      ),
